...
\subsection{MMX}
    Se escribió un código en \code{c} donde se multiplicaban dos matrices
...
\subsection{Forma de ejecución}
    ...
    \code{100x100} con 1 thread, dos matrices de \code{140x140} con 2 threads y
    dos matrices de \code{200x200} con 4 threads.
    ...
    \hfill \break
    Para compilar \code{cblas} y las instrucciones vectoriales que están en
