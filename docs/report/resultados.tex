...
speed-up real Gustafson se utilizó la ecuación \code{(2)} y para el speed-up
escalable de tiempo fijo se utilizó la ecuación \code{(7)}
...
\subsection{Cblas e instrucciones vectorizadas}
    ...
    código sin vectorizar y de \code{cblas}. Por otro lado se puede ver que
    \code{cblas} tiene una considerable mejor performance que el código
    \code{blocked\_dgemm\_sse} sin vectorizar.
    De esta manera se puede ver que \code{cblas} y las instrucciones vectorizadas
